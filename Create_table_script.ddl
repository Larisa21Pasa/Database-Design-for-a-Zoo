...
CREATE TABLE animal_type (
    ...
    var            VARCHAR2(50) NOT NULL
);

ALTER TABLE animal_type
    ADD CHECK ( var IN ( 'Arachnids', 'Bird', 'Canine', 'Feline', 'Fish',
...
ALTER TABLE animal_type ADD CONSTRAINT animaltype_typeanimal_uk UNIQUE ( var );
...
CREATE TABLE food (
    ...
    quantity_wk_food NUMBER(2) NOT NULL
);
